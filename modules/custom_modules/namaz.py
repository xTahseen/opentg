...
@Client.on_message(filters.command("namaz", prefix) & filters.me)
async def namaz_times(client: Client, message: Message):
    ...
    if 'error' in data:
        ...
        result = (
            f"<b>Namaz Times for {city_name}, {country_name} on {today}:</b>\n\n"
...
modules_help["namaz"] = {
    "namaz [city_name] [country_name]": "Shows the prayer times."
}
